...
public class MainApp {
    public static void main(String[] args) {
        ...
        //get the required bean using getBean() method of the created context. This method uses bean ID to return a
        // generic object, which finally can be casted to the actual object. Once you have an object, you can use this
